/* 
 * SnowPlow Arduino Tracker: Double Ping Example
 *
 * @description Double ping example for SnowPlow Arduino Tracker
 * @version     0.0.1
 * @author      Alex Dean
...
void loop()
{
  ...
  if (millis() - prevTime >= (15000))
  {
    ...
    snowplow.trackStructEvent("example", "double ping", NULL, "pi", 3.14159, 1);
